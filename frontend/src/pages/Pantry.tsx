...
const Pantry: React.FC = () => {
  ...
  const [newItem, setNewItem] = useState<Omit<Ingredient, "id">>({
    name: "",
    quantity: 0,
    unit: "",
    category: "",
    ...
    try {
      ...
      const errorMessage =
        err instanceof Error
          ? err.message
          : "An error occurred while fetching pantry items";
  ...
  const handleUploadSuccess = (ingredients: Ingredient[]) => {
    setOpenUpload(false);
    setNotification({
      open: true,
      message: `Successfully processed receipt with ${ingredients.length} items`,
      severity: "success",
    });
    fetchItems();
  };
        ...
        {!loading && items.length === 0 && !error && (
          ...
          >
            ...
            <Typography variant="body1" color="textSecondary" paragraph>
              Add items manually or upload a receipt to get started
            </Typography>
            <Box
                          ...
                          {item.quantity < 0.5 && (
                            ...
                            >
                              <Typography
                                ...
                                sx={{ fontWeight: 500 }}
                              >
                                Low quantity! Added to shopping list
                              </Typography>
                            </Box>
                          )}
                        </CardContent>
                        ...
                        {item.quantity <= (item.min_quantity || 0) && (
                          ...
                          >
                            <Typography
                              ...
                              sx={{ fontWeight: 500 }}
                            >
                              Low stock! Added to shopping list
                            </Typography>
                          </Box>
                        )}
                      </Card>
